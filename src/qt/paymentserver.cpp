...
const QString BITCOIN_IPC_PREFIX("freicoin:");
const char* BITCOIN_REQUEST_MIMETYPE = "application/freicoin-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/freicoin-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/freicoin-payment";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start freicoin: click-to-pay handler"));
        }
        else {
