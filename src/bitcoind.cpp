...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Freicoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  freicoind [options]                     " + _("Start Freicoin Core Daemon") + "\n" +
                _("Usage (deprecated, use freicoin-cli):") + "\n" +
                  "  freicoind [options] <command> [params]  " + _("Send command to Freicoin Core") + "\n" +
