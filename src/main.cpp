...
CBudget static GetInitialDistributionBudget(int nHeight)
{
    static CBitcoinAddress vAddresses[320] = {
        CBitcoinAddress("1DCyWRmTXB9goqA4Zb88nU1Q8snA7d7n4x"),
        CBitcoinAddress("1LoFvV5YJsSMkpyPLizqyWH8KAkevV2XwJ"),
        CBitcoinAddress("1JTUD2rB3FvbNFPw7cvCdTVDM9nuZTw7Jk"),
        CBitcoinAddress("18w4xQQj2iXwtq9smYkEAJrWVz4jQNU4xd"),
        CBitcoinAddress("16vdGLyxdYgSCT9xAng9Js7KrsnrUHsyG2"),
        CBitcoinAddress("1Lo8mmskrLnvCuthadVaRS4K7WUSFpWAwj"),
        CBitcoinAddress("1J1irQQ3ZWoTPct989Nnzdtu6WjfCjQcWs"),
        CBitcoinAddress("1MME2u4V2ZiU6uUVJXTZMg5sQXAyMBUNXt"),
        CBitcoinAddress("1CT3kUDi3rvma8R7Jwbz7puATSU3xzfLHz"),
        CBitcoinAddress("1CLupi58K9XHVeWZ8jwbWiY4Ns46mPALbe"),
        CBitcoinAddress("16A8XoWWvtJrDE1AdYQoLxAQcoLQML9gjz"),
        CBitcoinAddress("1NwgZoUnudfmbQ99xDRdvrYskgjQ7KBt1Z"),
        CBitcoinAddress("17CDPam7M59JM6vK5xzh1vUGKjYT9Byi5S"),
        CBitcoinAddress("1PyKZKfquWcu3PFzKbvmKZ2oJWXbmbsWdB"),
        CBitcoinAddress("186LbdeaDsn4Y5zrLN9cfSHWpQPSHtLbgC"),
        CBitcoinAddress("1MrQWWNKfVseYyGkyyLsDhFekJWGJNt2i9"),
        CBitcoinAddress("1EAUtv6YfvcRUrU5SncdZ27aSJ6SBNJH67"),
        CBitcoinAddress("1DuSbRKB1GL9cBeJLYsuh3DADdwJgvHAQN"),
        CBitcoinAddress("1MPdcnGXHsjR6rFSBUMm4ui44q8Ra1fYRT"),
        CBitcoinAddress("1Ntv6bDFj8eQnXjawcatnJjJTowo1BA8rF"),
        CBitcoinAddress("14j9vnqn6FZwPZmwdvGSuESm1m3oQsHP5y"),
        CBitcoinAddress("1C679HkKyki9rN8tJvtMNyXGLedPdo8zbb"),
        CBitcoinAddress("1EMKZYHTcnpHVUJx4dUp5Jne2ePQKjpdTm"),
        CBitcoinAddress("1PmgFAV835znVpUwGkLkvJrKc4ZzBqixNX"),
        CBitcoinAddress("16zKbgjQDqua6xjrXLhCbPGFrpr8UJxf4x"),
        CBitcoinAddress("1KPurbuUH5D6HRe3Y148kUbRjDyFCCm3VH"),
        CBitcoinAddress("1GVyWAXxP9tgZbj8iDSQqQ5tcN36uJ3F1s"),
        CBitcoinAddress("1E5udyBXuBt1e8c2R27AvSTdp8H7LEhmxr"),
        CBitcoinAddress("1hQcLTTD7KiFxiojvSrrrj8Y1w2gF5bHE"),
        CBitcoinAddress("17BJ1oZdZJS64curVAL6rN1yYN7YiNVXpR"),
        CBitcoinAddress("1LotiV7qGfAZhVV36XtrixnEfHCiuqe39e"),
        CBitcoinAddress("1Q5yedqC3adLpNjbY4CWMxPojoxnSCVGjw"),
        CBitcoinAddress("1FpBGhBWn7WDZr9nP47qG3DktJbaY7P48P"),
        CBitcoinAddress("1H6Nh8dRPZjMm3KViuW5ZESjRwqYnQ36nt"),
        CBitcoinAddress("1NAAKtpk7VRRUtA5ja8YxCZQaisXQ28HqA"),
        CBitcoinAddress("1JKxed9uYfvcPgjGdo1GQXwMQJkAnap34G"),
        CBitcoinAddress("1DZ58aSGD13QfUa118rtvfKrJiVPAoxdV8"),
        CBitcoinAddress("12wnNuaQHbLyThJVJvfePhV8UwQEWURLLP"),
        CBitcoinAddress("16f8S6f6ZDX3N1JG2DL5kyz9KCzmwpGgt7"),
        CBitcoinAddress("1PPKwAUZ6g5wWiopfyJKJZn3xUFcrJbSBF"),
        CBitcoinAddress("18DzCPRpU1Y2o5FsuuvcScZaYSi2ZBTVFr"),
        CBitcoinAddress("1E5fy7csgbN5G9ENRwvSwGSAibLdLk52pe"),
        CBitcoinAddress("1Dapd3WLAz1jm91FpNThHamXeMjDU4TJgJ"),
        CBitcoinAddress("15HQuReQzSQ1mrHWy3iYELyJLjGNe9gNEZ"),
        CBitcoinAddress("1DcJhNQJLkDrSmrvATciEaf95ZvnhFFUF7"),
        CBitcoinAddress("1ErNVYRnGQpzFmxkXYnqR4LbcCViby7Rfi"),
        CBitcoinAddress("1D1CmGn3BCM5rviTxZEfc7NhozAetePkit"),
        CBitcoinAddress("1Af3dbEWMK5VuMkUozepYPQgMeVtmKtvW9"),
        CBitcoinAddress("1JY2W5m4jsYzY2YYXU6RRKDmobE3BYEbgA"),
        CBitcoinAddress("1PdTBBm2xhCoUY4A6cfYCopaFDsFyTf4MY"),
        CBitcoinAddress("1Fe51wUzrhyGmag9UXmzEsr6jSyWqcATAM"),
        CBitcoinAddress("1kyb1A5jWYP49YTkoN2y3JFQuNp1S2gXa"),
        CBitcoinAddress("1FxZ7fmDQmauMASYVuVcHeajGZQKrQ1UWB"),
        CBitcoinAddress("1EwtDpNLPmUZNLFmGMmNTwviUVe3DuTFKt"),
        CBitcoinAddress("1NYRPya8KWUfiSr8fXxccPoDMmBw2Uqj1y"),
        CBitcoinAddress("16vQMSBZK7iy5HDFfeiP2WomfpGfSEPJx5"),
        CBitcoinAddress("12E9bCLYb9uzh2MHhpsyR89V3eLXZp5afr"),
        CBitcoinAddress("1EA4NJjMXSgVNsNgEc7nSyRf3epjp3ABrQ"),
        CBitcoinAddress("1NN442B74LAsXUMUFZSriWZCUh8b5ECFR9"),
        CBitcoinAddress("1EMaEQmjjDCjgu3auEam5ABQ1J9ZtdLdpV"),
        CBitcoinAddress("1RYXoGz2cHTGsYC5zZdDwpCdGRj4aBdAX"),
        CBitcoinAddress("19aDWt7kBf53uLANiWnLFnWo5CqASh79mi"),
        CBitcoinAddress("1LDEniSxXknXLHT1BMWpFsBM3PQcgn1nYz"),
        CBitcoinAddress("1Q4Lji94eWCC9xBzwrbRE9yTMYS5fdKg9z"),
        CBitcoinAddress("16fQVYur5CVMq9VfNLYypKXNeTmvWnDKsz"),
        CBitcoinAddress("1Mc3r8pCpuRiHhkD3DrWf89CUnZb6xbFbg"),
        CBitcoinAddress("18oEnf5iR9CD2HFDc9Yr8kD7m5CrJVWRkv"),
        CBitcoinAddress("12VDq99L8UQWr8Waqo4GreEGCEBnkxMaXy"),
        CBitcoinAddress("1H7PxhMmvqiRT8NDEkSFjfDekRLQ65CqBN"),
        CBitcoinAddress("17yC59RcpYsw7jX3Zw7c48AcWtJqaHUwAr"),
        CBitcoinAddress("1AFT16ksWdqdjhk56gFDaRnr7vS4XCVtyQ"),
        CBitcoinAddress("1G84MZVqN54QTD47YWWmimy9htaj1WC58U"),
        CBitcoinAddress("13YcisL6YyUG5nqegyqyrL6pVtrMqGYtcq"),
        CBitcoinAddress("1NYdmagVHfbqTgW4hYJKS2YnWrJzCnSsvZ"),
        CBitcoinAddress("1PumqgHPLUjPKfddgwJA46D5GBdYgT8myg"),
        CBitcoinAddress("1PFKxU6g1kQayDwvpiLX2vJgUghMqJz9Ck"),
        CBitcoinAddress("154ENKy3HuYoN8xARVaxp61NUAt5GEknDj"),
        CBitcoinAddress("12CJ8BD8L8tQXjrpy4UfjJwCCtoL6vsegD"),
        CBitcoinAddress("1LXCWYJ6k7EG2Bi8rLh2jhV94L4G768yTa"),
        CBitcoinAddress("1K1rbcUFmE7XScTsqiNEiJHyX69eqbZdDB"),
        CBitcoinAddress("1uZZzXiu8n7eL96rcFWh9MvcqerYxaGce"),
        CBitcoinAddress("1JidqtE1YHwXFC1utxPAp17RkM3rUqwULk"),
        CBitcoinAddress("1PuMwPqNLLYi1sPxvJToid2EsfiP4xPfo6"),
        CBitcoinAddress("14ZSJRvSdgYFA1xUM2txnQKdMXMfsEWvuJ"),
        CBitcoinAddress("1D9RJw7p5zgz4JeWvVzYxBsAkvucRMiXfG"),
        CBitcoinAddress("1JRpRLZgcfNNeVEwGQmYZw5nv7Aq3KVx5x"),
        CBitcoinAddress("17Rqyx39YnpFN23dPE3CWRPC8JhuBVKktx"),
        CBitcoinAddress("19pozj4JeWd6rpMDeTpx8d1Dv4rebhUkvT"),
        CBitcoinAddress("15jULtTPTzXHr9ezTMFbaPJojbuYFrbrQp"),
        CBitcoinAddress("19dfCSTERPh5j4XtYoJatjdjD9afReeY3s"),
        CBitcoinAddress("1LgzNc1Sfbu8BaxKUESGbNzCNnpqvhpCi4"),
        CBitcoinAddress("1HTvoZUUNncPkjjv17xHLEtncdrgcdnN46"),
        CBitcoinAddress("1NHvSZWwk8RtgPvfhzykpvebQnVk1Q5XxX"),
        CBitcoinAddress("1AzdeDfjz5C5yT6wVxurgS8QPkZviHvY8N"),
        CBitcoinAddress("1BdFwnfS84uDeZn4sojUs5ZC8fSkx9o2XG"),
        CBitcoinAddress("1AgCAgvQZPQTkdMg853SkM2WdRzN4Q2ATw"),
        CBitcoinAddress("1JABYERsgkAYincsgCpic7MwV63iM19iXp"),
        CBitcoinAddress("1JFudqZDUkBMdV4ShLmhxLD7sfNEYdBQCE"),
        CBitcoinAddress("1Pqf48Skyxt77RNVwTLxUhA2BNCscaHJKa"),
        CBitcoinAddress("1AtdTwFFYZJrUUSWbBLBCkodRcnqwb1a6G"),
        CBitcoinAddress("14iezrH1nR9TjGtnywFPqBHbwYcEhwz8y9"),
        CBitcoinAddress("16x2aavFb2AHKntUnzA3HC2wmi921YJn4i"),
        CBitcoinAddress("1HovjtiToM6f2xV3Sxg4fxfvSYPCGGEXLe"),
        CBitcoinAddress("1MNrqZyo7poywLPVap6PsmmT5CS4f8hyWq"),
        CBitcoinAddress("1F6PzQRW2MPfCYvzgeUXoBXaEikH3E5zMk"),
        CBitcoinAddress("1F2SpgUakBvx6aNgJiCtEZHnTqVWeQcoMk"),
        CBitcoinAddress("13iTRwxSLGC17fzumSrRidaXe8v8awdDux"),
        CBitcoinAddress("1KuyBiZBdXVq8oNGAPWEqWiFi2RyH8rvwd"),
        CBitcoinAddress("1HdXmhHKkkzpn1UKmhBWFzQMYsUqxUuVZ9"),
        CBitcoinAddress("1Dw9jXoWc5MsEH3uLB9pi98qeyijUrvWU3"),
        CBitcoinAddress("15mW5WsusPo6LAAYLqa6ngFfQ1jX51v3Bn"),
        CBitcoinAddress("1DFfarcjskvSi2w56msV4JeeVZqtuwEL9p"),
        CBitcoinAddress("12SeGWd2txi4fdQKoFXsTdd2fgjDbABWyb"),
        CBitcoinAddress("1MoENmjtakS8XTHcwsbVFeJkjEckMhS3xm"),
        CBitcoinAddress("167pv4Hn53XQ4hFhyNtEyP36n8HrL3NU3j"),
        CBitcoinAddress("1E6WgpC4bmYJagvsTzhRxZ1Z8sRSsQjmJX"),
        CBitcoinAddress("1EFkVCzezsZCq56JWSBRf3Dy6tafFRxh4N"),
        CBitcoinAddress("1KnKZwDb44Qf3Lutda2T85uFZiTZwe2v2C"),
        CBitcoinAddress("1CLpF2fLukzBHard43mXLEXxz11gFK5dc9"),
        CBitcoinAddress("1DXSfPi1Tj6tQ5qf5M6Yj6cpNmLfPKMwr1"),
        CBitcoinAddress("16nHP74UsqeHewM1yUhNCL3zCjkWnqFt8g"),
        CBitcoinAddress("1FeqXkG9jGEDcPaKJV8rdh4NbqTjbdvN4a"),
        CBitcoinAddress("1LwwjmsoDtQ1Zh9N8doGMczP1TJnes2YoZ"),
        CBitcoinAddress("1DgusdNgB6nRD2emfwURMmk33LrB7Wp95c"),
        CBitcoinAddress("17kjPofVVmhZAWXnrVwfqizGtXWBufWwbf"),
        CBitcoinAddress("1EnLHA3U15wXehXAC24W587EEaeyUcaA6K"),
        CBitcoinAddress("1MwpkFtEwrAQNbsmbt4kB9WtoB8mFLXZ44"),
        CBitcoinAddress("12iQRcVoRCbFNvoQARM3rufTkd7jXpHZEm"),
        CBitcoinAddress("19zK2WFDkaHZfWa4uS5mzF2XD1KrZEMxy2"),
        CBitcoinAddress("12Zs8LtRY1cTS3HKw1gwPzYjB1Ar6Er93R"),
        CBitcoinAddress("1KDVcQhjZuX39Fvv8QbrSpaSycMA4YdPkU"),
        CBitcoinAddress("1AT6rxNBT8sasYKrKm9fv7LdjXBS89Wewh"),
        CBitcoinAddress("19YjbLEUgqV8joQMgijDWZoY1inwXf1hXc"),
        CBitcoinAddress("1EpHQ43BkzmKYMiYwmRRKEXQidpgA499px"),
        CBitcoinAddress("13bQP93mmUFtUGVuBEwZ9ymdbCC9yywgdL"),
        CBitcoinAddress("1GatPyGkCX5YUW4f2QHJk1PzwspCRz9b3J"),
        CBitcoinAddress("1Jk8sCUfHVE6VpwkkTG9qaYYS9u1zMmQAs"),
        CBitcoinAddress("13N4Eiv2KiX4PeFwiWnC847JBv4TP2sn1Z"),
        CBitcoinAddress("1ESzED9saJ3bVB6BbVSTFGDxRLnTgWRVDC"),
        CBitcoinAddress("1CspvzG7HyuNXRLsaWnpsLXPDwkeDKd4mm"),
        CBitcoinAddress("14Rs4fo9tK39kyEFoAjbvkcgGZ6k356t3T"),
        CBitcoinAddress("1D6jgPJYoFhbY7gJjNMAbyfJzBGVtqSc1o"),
        CBitcoinAddress("16MHoaVyYQgPU525fz2auJpK6JVyFKEiz1"),
        CBitcoinAddress("1FfS9TQswYZHYDNkUmncRAYjYJkLzGncp5"),
        CBitcoinAddress("14PXPSEjNjWAuqYa63RBT6gewnomE9saRu"),
        CBitcoinAddress("1CHBBtBCRQz1TFyE12g8RbGPZ6UzX2AieC"),
        CBitcoinAddress("1CMwT1jzfoe9VvURpZanaXVQobMQLr13W8"),
        CBitcoinAddress("1696KNrMvHvnthPLZnGuYGY96UbEqLeXz6"),
        CBitcoinAddress("1A7TQi9sMiNQX8uwwqFb8eqaXnpTJY4WYg"),
        CBitcoinAddress("1GNuX6AN2KCF1AWtxAT9QYD6QRJubRvKaz"),
        CBitcoinAddress("16L3CvHeZcZcr3wPhoEC3ZsMLN7YTonMTQ"),
        CBitcoinAddress("1EnqRdqx1VZyfc5ia4pcmZstBcGdW8FGxn"),
        CBitcoinAddress("1MQ1QeCMZhxFCgReGEPRS2Qy74FaPqFccW"),
        CBitcoinAddress("16Za6Rn8dCmM8gctXQtwN1yQ2WXnhHsSgs"),
        CBitcoinAddress("15k38dy86CRnirMY9Q1niVmfn7nfXTmppL"),
        CBitcoinAddress("1MQsruCXBjCZzTZKKpPwcC74ztetbtAw4E"),
        CBitcoinAddress("1cmAt63c4ZAqRe2fBQTYs5Jyx41fiBbhQ"),
        CBitcoinAddress("1PBCaowV7gQM6Lj1NfSpH2TnHHmqXcYTsC"),
        CBitcoinAddress("1841uXFc2kUTUogCDJwp4U1NPjSPqsg69x"),
        CBitcoinAddress("1XNo9kDMM6uqvf9yCWmqj17rukC8abjtb"),
        CBitcoinAddress("1A4kHAe6rNz1q8G6dYjNMyWzgVv4DxYget"),
        CBitcoinAddress("18Y6y6zcJrG5j2RjmGqsUvtWkZhnTvRka7"),
        CBitcoinAddress("1DkcMkHWUUVjXgAu2MFXVkUuwZ6JWv64cz"),
        CBitcoinAddress("1JvXTyBxhjE9mERWEFnqeuAPgbJSi25qGd"),
        CBitcoinAddress("1FHus2MsM8k4oKHt22YFYeoFkf65kxQFP3"),
        CBitcoinAddress("18HLkAhrzeNsaMB3MY1xUGW7wkzjWGobT7"),
        CBitcoinAddress("1AF7KmTRrS3mMxop2Viop1MctrNJmPAHQt"),
        CBitcoinAddress("13g4rWjU2PK4eN9D9XXo4jRB84RiJ2hD7o"),
        CBitcoinAddress("1EWUiUoxZXfTbZXDZGueag7XRnv5Mej8ZZ"),
        CBitcoinAddress("1LuuGk4tyd4USQqtYypemjt5vs3VRqV1QU"),
        CBitcoinAddress("15eUUDUYDuiKnt9xNbzhNFmorCK9F9mJb2"),
        CBitcoinAddress("1HGzWgdrNAKsE9nE1GHtUvaXHNzvwTyPQX"),
        CBitcoinAddress("11MhmCVmFszm6yTTwaK2dypwcLaybmCjp"),
        CBitcoinAddress("1s9XWpGPQqhbog1S6xgGqcVnfvnLMAueZ"),
        CBitcoinAddress("16f3tHcuRavx3tSWCM2jnnCX5jGa2vJe9Q"),
        CBitcoinAddress("15NWaghRx51ravYTUqsnBF2hQFQeSHtTvS"),
        CBitcoinAddress("1QGUUgikmqCinDQn3vfqx9q6mnT5ekA4BG"),
        CBitcoinAddress("134WvpvyZUveYc98CmtWZc1oBBXdrV1GuU"),
        CBitcoinAddress("1LqNfcDBn7eytc7Ln6fLrCDLkYeMa6R9dV"),
        CBitcoinAddress("14xbponjm6rXp8cNzTJmtCJwvwvDuKvaCD"),
        CBitcoinAddress("14D7JyUrv1HeSD7FCc8WupmbxUiGyfC7uC"),
        CBitcoinAddress("1ER6GhDJokhBjB73DWDTdC2BP2J9DiqD1o"),
        CBitcoinAddress("13Q3or3Hew7hBZzMoriz8LcMXwptqD5HEd"),
        CBitcoinAddress("1HSyeVQEvdRwj2rutFN33cKu2tPzyGkgx2"),
        CBitcoinAddress("1A1WaQQ6ZjXuEe2KYZNC3ycPg4X9czsR4D"),
        CBitcoinAddress("1fhzxkMPY4hUYNywoQwyVGkinVKQrPJ2P"),
        CBitcoinAddress("1Nf63BqwEmb7vU15bRfpvKEs5tMGZpR5Fi"),
        CBitcoinAddress("1Gi6tjnRBecQovhRQVNmsPyVZYmphZerdg"),
        CBitcoinAddress("1AJ87nhgSQkac9BUjEvbyWh8c95ciHLZWG"),
        CBitcoinAddress("1WDyJLrJaLRePMtea6bAgADwzdpbW5nqd"),
        CBitcoinAddress("1JTvhcJuxydevXw4ocUUteiPNWwPtMM56H"),
        CBitcoinAddress("16X1LYmpxM2fPBjNTLbnPo2LdA6sB7fbNu"),
        CBitcoinAddress("1315ZWhxgd6pqqTmvF21fxt5wzYvpcnZSm"),
        CBitcoinAddress("17PWpyrUmkaCVPu6KXaWvuLLYvD9YU61RP"),
        CBitcoinAddress("1PADxQpcx8Kvs3PprjYvM1wYFyjxB3tcs8"),
        CBitcoinAddress("1BWyJmxybx3p1guhud8qxabrGbVLWaVNaM"),
        CBitcoinAddress("17JpmLSEbXgmheAvTQ7iiBvR5TaSsM2Xgt"),
        CBitcoinAddress("19oxMuyyipVsvxXWKBBrFmY8hQbWkiiVEv"),
        CBitcoinAddress("16TvroBFWJmUN7VSHQLmyh6KiCri5QVTQu"),
        CBitcoinAddress("1MXJR6XRoThY9rwvyvLkXWN17WN7rAQC4J"),
        CBitcoinAddress("163N8CmDAf45CM6brXMpzg3AN2nkDXTuRt"),
        CBitcoinAddress("1CWudCKLCxT5AXteLFeZRBDyb4moQH4cVL"),
        CBitcoinAddress("1DYmgt2zpW2eNfyczC98aq76URHQMnfwZK"),
        CBitcoinAddress("1JnE2YseXgBX4oHGo8VywsxnNkp52s6nkX"),
        CBitcoinAddress("1D8WBBBCHhgLrMa8s3QU1bkRcRHEt8cNfv"),
        CBitcoinAddress("1Fm5eoDvEZo4hyW4YEDu3q2gKbpCuo9hqw"),
        CBitcoinAddress("18uRTixnVaKMz9tyoR6Ve6Rqdwtt8oZ1Zw"),
        CBitcoinAddress("1FuByKdd2RK3hjc3UFeV56HvheyAMnjMMS"),
        CBitcoinAddress("17nDqatJ7M6M9vFRa4BngCCLPGSJ6mfc8b"),
        CBitcoinAddress("1G4qHkiaaVZwuLqwvh2itFjR18iThkeaDQ"),
        CBitcoinAddress("18ZcHUg5wV4sSdd9pS7xv5rYsfx5D1hZWi"),
        CBitcoinAddress("1CZU6UCZjtWueXQWYzyrFa4K7pTSeBQ8cw"),
        CBitcoinAddress("19zRVJvXaXZvygqbHAP1ZKF5Rx9gq3Xh8u"),
        CBitcoinAddress("1HQAyw9UUi2eiQHJcnbg5eeJTnv2QoEQqA"),
        CBitcoinAddress("16eZAqdqypn47T8DwS1archd39uXqK8JQ8"),
        CBitcoinAddress("19he5Hy915MbSZBvwHjB3LAm5UyLnmQ5TK"),
        CBitcoinAddress("1CzGcY5JKDroUtdFdZJArGeEmKMEtyeAKw"),
        CBitcoinAddress("1DzowkZrtEQgoDF8xgxjPBfLaBMeBHjNr2"),
        CBitcoinAddress("16GA6zc9iTUB8o47oi7fbE88ayEi8C7w2r"),
        CBitcoinAddress("1Mvp5TikHrzJetDMbjHkzAkP9rMBfQrais"),
        CBitcoinAddress("1Lrbk1vrmCqVfajBqtwHD1x9x72jeDCon5"),
        CBitcoinAddress("1AMDHRKUah3J8yESFt7NnoUXrM4ULHcUpN"),
        CBitcoinAddress("1MbnTTv5FJX8RsK5tw9KjNx1VCvo94GEKK"),
        CBitcoinAddress("1Hmbm1TUDuDwdVWkU1oiaReRRBTzb8fMDJ"),
        CBitcoinAddress("15XYapuYSjaDc4uDXJsf3PF33YzSRs5P3M"),
        CBitcoinAddress("1C3ovhhZwo73isNQPuKKD5VDm2XwByBkTK"),
        CBitcoinAddress("16VJrBFjFjhLY93NihDvWqBpUeiXeL2FUi"),
        CBitcoinAddress("1C9Niuy1cSW6a6g5tm8GhPsSML6ZtWeUQS"),
        CBitcoinAddress("149937wZtsTvtwmixD33npnsnyUm5zjstX"),
        CBitcoinAddress("1NkCKjPZUFecVWxLGnJbN7Fp8viJRG5Xg4"),
        CBitcoinAddress("1MG3okwhF3YDwVWDcYsNr5ySA4eMtCATrK"),
        CBitcoinAddress("1GtzbwNuHYBZaDRVpJGuDwjBQhSh5RBVRZ"),
        CBitcoinAddress("1CJi6dja55AtGeuJX6WLFGTHsoofqZyDNu"),
        CBitcoinAddress("1oftVXkjfpJSMKGnz1pps1xVWNUNNhAmq"),
        CBitcoinAddress("168KgGGUEEx22eCNuSMjsKvn5chiZ5c217"),
        CBitcoinAddress("1FmQzGLJFu3AvucwDEAjYRM4fPgiSZsT6Q"),
        CBitcoinAddress("1F9t4EmWXy2Wui21LaMuZmRDwRCF38aDZN"),
        CBitcoinAddress("19eFuss1dgxPdDfoAu6AsVmBUj5d2DUPu3"),
        CBitcoinAddress("15Yr2PPbFGqbi2SZtZ59cvd5y2Es8atRE5"),
        CBitcoinAddress("1Pz8oisCda5aJXtVVDo1mfxxvgymVNcmsM"),
        CBitcoinAddress("1HkHQHNkjXp6VinoEG6a1i55NmreXC9yAX"),
        CBitcoinAddress("12ShPmbsADZMacnr5u2DPxssKXjd3HaCZc"),
        CBitcoinAddress("1BasQDDfZ677LF3mEAQUEFHvJexZ8ZxY47"),
        CBitcoinAddress("1FVXTVaK3rwSrx67WGdNkNFwL5sVm81TEK"),
        CBitcoinAddress("1NV8VjVBrkgCTJvyBHZumboXjPtSNZvRJX"),
        CBitcoinAddress("1HVdN1BSusJZ42sSfJFHB2CJ6LcW5Fz31a"),
        CBitcoinAddress("12j2yfUP2dNo3HwdrTDjMGZhzBcdhYvFj6"),
        CBitcoinAddress("1BrWHBKCpvNYssq8Kj8yY6qvy7GqFgk8UP"),
        CBitcoinAddress("1G3faUnBxMHwwX2uLn6dZJEj9pmJ2o5cnq"),
        CBitcoinAddress("1Nq59Py1u73B26aTTRhZG3g9h5fmrmkeX9"),
        CBitcoinAddress("1DMuz7B193myzVq4Kgg76Jb6Da2UjkAti"),
        CBitcoinAddress("1124BMmAevhic3H1MQB3teQFhoVi7RVUhR"),
        CBitcoinAddress("1B1hrgcDNfSuaKJi3oJ4cBtyysq2BpGFz8"),
        CBitcoinAddress("18NE1w2soK6xGUYYvoTe7oEtRtQhxBLXCq"),
        CBitcoinAddress("1MESy7CY2yTgxSERyejcvCGjK8Qm2EhE4g"),
        CBitcoinAddress("1445Hs1Lgh9pPvD8mSt5oiGwTY8yT2sy9R"),
        CBitcoinAddress("14pm2Fxwin4mwHqd5ujXAXTJJFuQ31qYUf"),
        CBitcoinAddress("17UhQpeFQ3nCjj8PJKCrTWHnP8YSvrNM7h"),
        CBitcoinAddress("15zVu5t8iURV2feuvmnHgYp9u7cxPC4XrN"),
        CBitcoinAddress("19JriYALeNskNnvjYidpoNHNLegftkViqH"),
        CBitcoinAddress("13mauBB6JYTPcfoWbNbCWKk4sNqmwxCXse"),
        CBitcoinAddress("1LwRt9rpGaekbht7UAitg2ADmFtDrKThYV"),
        CBitcoinAddress("15Z9wnxM6VxrRkqhLZpLskGRJ2dLRMEmCg"),
        CBitcoinAddress("1GvQwfMSMRggmmFCRqf1EmvaG5U5sY4sKL"),
        CBitcoinAddress("13iUoiiVq7C4fUmy94r1HEDf35YKwBAVXh"),
        CBitcoinAddress("1ELZsnzgBmZSSxQQYuAANg8izDFTbzhbPB"),
        CBitcoinAddress("13me2Z71XAtmkzggnqusdvuRiXZzFRGZBj"),
        CBitcoinAddress("1KC7ECvdcofiYXJ63iUnvFrEH4zzhQZ2pB"),
        CBitcoinAddress("1LtFLa3oaEBhmHQ5iXRvFqeNcrzU8GPNMM"),
        CBitcoinAddress("1LNHH8DGXWQRyfmkSkaJcBkkiVxUhH8tBM"),
        CBitcoinAddress("1Daw5kGzsqBhfRfMV6dAA4bgBZ2LBWS1nY"),
        CBitcoinAddress("164XLENwRiappRPUP47sRTSyXtW8CAXVLi"),
        CBitcoinAddress("1CFoTaknkFGADVo2rK92jwq18NWBzVcJGS"),
        CBitcoinAddress("1MnrNuPrnuJFxYnkpKDqUymHGjb1d6qLVq"),
        CBitcoinAddress("1BpwPwf8kUssmoMCoWnHCVY4wjBJi3CZyD"),
        CBitcoinAddress("1jiJb2DU3DB6ujD8eV3DZXmnfwWaHti4y"),
        CBitcoinAddress("1DqQnvWdtKvwBtePpCbDd8juZ9ZbeaKFdH"),
        CBitcoinAddress("131D32PNpqqGtLGUaAaZePqpUdBTiy8Akh"),
        CBitcoinAddress("16jK6KaY7Ub7fZ7YaBi94ZsygovzixnRNx"),
        CBitcoinAddress("1EJx1ShX4UJVrzynP3oZw8wdLpSGC1KPrz"),
        CBitcoinAddress("1899kFmma5FongtN9JfvFKqhwtbw2w9MDe"),
        CBitcoinAddress("1FNNBK9SeDUufbbnmoagUFt7oKVbb65vaw"),
        CBitcoinAddress("1LxF4pLjeSpNs4ux24MDduzCzrM2KCsE7M"),
        CBitcoinAddress("1BZjVRe2CCA7G7qnG3beWWhG173f1mbNX2"),
        CBitcoinAddress("1L5HWs7WrK457CzjAgnHghveFpQVv7rRTe"),
        CBitcoinAddress("1Kp4bjG9nwbogd8WM62ijGG6onW9Wo4aYK"),
        CBitcoinAddress("1hhvJ4QmB6RX12Bps9xhnMHCDDXTXAnDu"),
        CBitcoinAddress("19xiuTYSm85gNsPZw8hGLS69e2DjVbCuAP"),
        CBitcoinAddress("19WdcJU8Z1W3ZZnbpfDRbdrYGapxp1L5zo"),
        CBitcoinAddress("121hT7w8DN3x1pYEowak7FjmNgihMNo2cd"),
        CBitcoinAddress("1BtthjPb9GPKwgcJtrgZRQRWhiRSCHmyvk"),
        CBitcoinAddress("1JKgRTkMgEodFFpPwoz9W6pejMN3x3J9X1"),
        CBitcoinAddress("18zp4dHdouYqFn2qC4ttAva8cwqhZ4pm4K"),
        CBitcoinAddress("1ELAVZKvGykuzRDCvFUsJTL4istYisbxpK"),
        CBitcoinAddress("1PfULZdJniM8SutFdjoKvG3WLUwxZL2YUf"),
        CBitcoinAddress("1DTbnuz4dPLdduseE3k5xr62eFAYjCSk3E"),
        CBitcoinAddress("14jVGdWJRcqpdgWPAbbvhMfVnLha6MdnYU"),
        CBitcoinAddress("1GBiMVjsqkcGxij2hGFQxVUX2WjDcr1Esf"),
        CBitcoinAddress("1FGUuAuGRkSqEL8Besg33QsekxmBB75ZUH"),
        CBitcoinAddress("19FsZeejdbfUKK21wENRdoR2BUowD4FsMZ"),
        CBitcoinAddress("1LbBHWffmANdhcb1Wciv4jWwXPGrtVFhsU"),
        CBitcoinAddress("1FT9PRuDmFKxZorYrfgibWaaBdKWv7PiB4"),
        CBitcoinAddress("1FUvPJ3nXMUrFEWqkjxPe5esqQ2GoCmUAk"),
        CBitcoinAddress("1LJLBDK8q7yLibK2oYTA6hbD9UpmP6U3QP"),
        CBitcoinAddress("14E9GEg9T5N9aja1FV2ewNFjMK6wPEgsKb"),
        CBitcoinAddress("1JYmABbYkUjAyowLwa1zoQj86PEWMBdeZP"),
        CBitcoinAddress("1NCfTbrEsZrCT3Efyk5AfvqP2xY6NesWHy"),
        CBitcoinAddress("1Bwd6rcgGLq8sdo3FHHSmh3J7ufqdgMeqi"),
        CBitcoinAddress("1PzAWHEt2xabgWEki5hTgwtTyuKRS1at39"),
        CBitcoinAddress("1Fo3r7DWDtJ8Yu2UqngNqKMSw98XgsXehW"),
        CBitcoinAddress("1H1b6FLd5eqH8Q9Cw8UkZv2nY3xxKTfsH3"),
        CBitcoinAddress("12x9TqiF9FQU7sqnRiCmrRZmG7dLs9hyG6"),
        CBitcoinAddress("13VYYQ8K9AFiajev9QdHM6Kj8SqevRT7GS"),
        CBitcoinAddress("149HFz2K7D4GffQm8t7rKQuWmcwJohsimk"),
        CBitcoinAddress("1JqwkYTg3ZuWMpjhxrJYgW7E826HYoiBSG"),
        CBitcoinAddress("1NiyjCKxM33nozwzU2LNtWBPWrWTUpiaAM"),
        CBitcoinAddress("1LD4F5tA87e7nMwNRuHhgwH6zTFZ1LyoE2"),
        CBitcoinAddress("1M3wUX9YYrcVSSw6Tncdoic3Fj13okQ63u"),
        CBitcoinAddress("1PVKsqeVqM4B2ccq915GHeK3aDeruStr24"),
        CBitcoinAddress("1PKNQqSuPknZ1PaqKkRqa9qYujWKL9KQ7E")
    };
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000e6403d51942e9606fc718ed4bb32c16f0e5c1f4ae08b858b07f65a1e");
    }
...
\xef\xbe\x8c\xe3\x80\x80\xe3\x80\x80\xe3\x80\x80  /\xe3\x83\xbd \xe3\x83\xbd_\xef\xbc\x8f\xef\xbc\x8f";
        ...
        if (fTestNet)
        {
            block.nTime    = 1394020800;
            block.nNonce   = 1384874660;
        }
