Freicoin Core integration/staging tree
======================================
...
out collectively by the network. Freicoin Core is the name of open source
software which enables the use of this currency.

For more information, as well as an immediately useable, binary version of
the Freicoin Core software, see http://www.freico.in.

License
-------

Freicoin Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
